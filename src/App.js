      ...
      <header >
        <ul className='site-header'>
          <li className="nav-styls">
            <a>
             <span>ME<span style={{color:"#B19149"}}>S</span>SENGER</span>
          ...
          <li className="nav-styls">
            <a>
            <span>E<span style={{color:"#B19149"}}>X</span>PLORE</span>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="#005354" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="nav-styls">
            <a>
            <span style={{color:"#B19149"}}>EPROJE<span style={{color:"#005354"}}>C</span>T</span>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="#B19149" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="nav-styls">
            <a>
            <span>PRO<span style={{color:"#B19149"}}>F</span>ILE</span>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="#005354" xmlns="http://www.w3.org/2000/svg">
          ...
          <li className="nav-styls">
            <a>
            <span><span style={{color:"#B19149"}}>W</span>ALLET</span>
